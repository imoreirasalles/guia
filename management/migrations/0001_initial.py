    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Ex.: Aquisition from The Photographer...', max_length=256, verbose_name='Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_auto_series', models.BigAutoField(editable=False, help_text='Auto Increment ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='This is an auto set field', unique=True, verbose_name='Universal Unique Identifier')),
                ('title', models.CharField(help_text='Type of acquisition method', max_length=128, verbose_name='Title')),
                ('description', models.TextField(blank=True, help_text='The description of acquisition method', null=True, verbose_name='Description')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_auto_series', models.BigAutoField(editable=False, help_text='Auto Increment ID', primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='This is an auto set field', unique=True, verbose_name='Universal Unique Identifier')),
                ('title', models.CharField(help_text='Title of Management Unit', max_length=256, verbose_name='Title')),
