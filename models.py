...
class Colecao(models.Model):
	...
	entry_obs = models.TextField('Observações', help_text='Insira observações sobre a coleção', null=True, blank=True)
	resumo = models.TextField(help_text='Faça uma breve descrição da coleção', null=True, blank=True)
	...
	teste_array = ArrayField(models.CharField(max_length=200), blank=True, null=True)
