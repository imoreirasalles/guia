...
1       | Parcial   | Estado de conservação | Existem restrições ao acesso físico a documentos originais cujo estado de conservação coloque em risco a estabilidade ou a própria existência dos mesmos.
