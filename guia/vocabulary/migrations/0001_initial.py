    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_type', models.ForeignKey(blank=True, default=None, help_text='Select a term', null=True, on_delete=django.db.models.deletion.CASCADE, to='vocabulary.Term', verbose_name='Type')),
            ],
            options={
                'verbose_name': 'Term',
