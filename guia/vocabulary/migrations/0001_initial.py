    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_human', models.CharField(blank=True, default=None, help_text='What this thing is?', max_length=32, null=True, verbose_name='Identifier')),
                ...
                ('term_type', models.ForeignKey(blank=True, default=None, help_text='Select a term', limit_choices_to={'vocabularies__id_human': 'term_type'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='term_types', to='vocabulary.Term', verbose_name='Type')),
            ],
            options={
                'verbose_name': 'Term',
