    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(blank=True, help_text="Choose some collection's authors", to='person.Person', verbose_name='Authors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='This is an auto set field', unique=True, verbose_name='Universal Unique Identifier')),
                ('id_human', models.CharField(blank=True, help_text='Institucional Identifier', max_length=64, null=True, unique=True, verbose_name='Institucional ID')),
                ('title', models.CharField(help_text='Ex.: Container of...', max_length=256, verbose_name='Title')),
                ...
                ('items', models.ManyToManyField(blank=True, help_text='Itens that composes the container', to='digitalassetsmanagement.Item', verbose_name='Items')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='collection',
            name='items',
            field=models.ManyToManyField(blank=True, help_text='Choose some items that compose this collection. ATTENTION: You can create a container and aggregate items there', to='digitalassetsmanagement.Item', verbose_name='Items'),
        ),
        migrations.AddField(
            model_name='collection',
        ...
        migrations.AddField(
            model_name='collection',
            name='thumbnail',
            field=models.ManyToManyField(blank=True, help_text='Choose some introduction and representative images', to='digitalassetsmanagement.Thumbnail', verbose_name='Thumbnails'),
        ),
    ]
